...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn"%>
    ...
    <%
        // main function to start payout 
            String hashString = "";
            String hash = "";

            String payoutDate = clean(request.getParameter("payoutDate"));
            String email=clean(request.getParameter("merchant_email"));
            
            String hashSequence = "merchant_key|merchant_email|payout_date";
            params.put("payout_date", payoutDate);
            params.put("merchant_email", email);
            ...
            base_url = "https://dashboard.easebuzz.in/payout/v1/retrieve";
